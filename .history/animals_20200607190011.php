...
<div class="btn-container">
    ...
    <?php if ($total_animals > ($current_page * $num_of_product_per_page) - $num_of_product_per_page + count($animals)): ?>
    <div class="nav-btn btn">
        <a href="./index.php?page=animals&p=<?=$current_page+1?>"><i class="fa fa-chevron-circle-right fa-2x"></i></a>
    </div>
    <?php endif; ?>
    
    <?php if ($total_animals > ($current_page * $num_of_product_per_page) - $num_of_product_per_page + count($animals) && $current_page < (ceil($total_animals / $num_of_product_per_page)-1) ): ?>
    <div class="nav-btn btn">
        <a href="./index.php?page=animals&p=<?=ceil($total_animals / $num_of_product_per_page)?>"><i class="fa fa-angle-double-right fa-2x"></i></a>
    </div>
    <?php endif; ?>
