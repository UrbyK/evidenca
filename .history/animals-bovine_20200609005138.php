...
<?=template_header("Živali")?>
    <form>
        <select name="animal_types" onchange="showAnimals(this.value)" id="animalShow">
...
function showAnimals(str) {
  if (str == "") {
    ...
    xmlhttp.open("GET","./index.php?page=animals-bovine.php="+str,true);
    xmlhttp.send();
  }
  console.log(xmlhttp);
}
