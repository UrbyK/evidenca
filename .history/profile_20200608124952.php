                ...
                <div class="card-body">
                    <form class="content user-info" method="post">
                        ...
                        <div class="form-group row password">
                            ...
                            <div class="col-md-6">
                                <input type="password" class="form-control" name="password" id="old_pass" placeholder="Staro geslo" disabled required>
                            </div>
                        ...
                        <div class="col-md-6 offset-md-4">  
                            <input type="button" name="edit" class="btn btn-primary" id="btnEdit" value="Spremeni geslo">
                        </div>
                        <div class="col-md-6 offset-md-4">  
                            <button type="submit" name="update" class="btn btn-primary" id="update" value="Shrani">Shrani geslo</button>
                        </div>
                    </form>
                </div>
            </div>
