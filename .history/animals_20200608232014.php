<?php 
    ...
    INNER JOIN users u ON a.fk_users = u.idusers
...
<div class="row animal-table">
    ...
    <div class="controls">
        ...
        <?php if(($animal['idusers'])=== $_SESSION['user_id']):?>
            <<a href="./index.php?page=animal-edit&id=<?=$animal['idanimals']?>" class="btn btn-primary">Pogled</a>
