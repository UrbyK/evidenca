...
<br />
<button class="btn btn-primary" type="button" data-toggle="collapse" data-target="#collapse" aria-expanded="false">Komentarji</button>
    ...
    <div class="container-fluid">
        <div class="row">
            ...
            ON c.fk_idusers = u.idusers WHERE c.fk_idanimals = ? ORDER BY c.date_add DESC";
                ...
                <div class="col-lg-2 col-md-4 col-sm-8 col-12 acomment">
                    ...
                    <?php if($comment['fk_idusers'] == $_SESSION['user_id'] || is_admin()): ?>
                    <div class="card">
                        <a href="./inc/comment-delete.inc.php?id=<?=$comment['idcomments']?>&animal_id=<?=$comment['fk_idanimals']?>" onclick="return confirm('Prepričani');" class="btn btn-primary">Izbriši</a> 
                    </div>
                    <?php endif; ?>
                </div>
