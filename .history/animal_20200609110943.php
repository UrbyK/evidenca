    ...
    <div class="row">
        ...
        ON c.fk_idusers = u.idusers WHERE c.fk_idanimals = ? ORDER BY c.date_add DESC";
            ...
            <div class="col-lg-3 col-md-6 col-sm-9 col-12 acomment">
                ...
                <div class="card">
                    <form method="POST" action="./inc/comment-delete.inc.php">
                        <input value="<?=$comment['idcomments']?>" hidden>
                        <button type="submit" name="delete" class="btn btn-primary" id="delete" value="">Izbriši</button>
                    </form>
                </div>
                <?php endif; ?>
            </div>
