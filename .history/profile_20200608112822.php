    ...
    <div class="row justify-content-center">
        <div class="col-sm-8">
            ...
            <form class="content user-info" method="post">
                ...
                <div class="form-group row pass_control">
...
<script>
    $(document).ready(function () {
        $('.pass_control input[type=text]').prop("disabled", true);

        $("input[name=edit]").on("click", function(){
                $(".pass_fontrol input").removeAttr("disabled");
        })
        $("input[name=update]").on("click",function(){

            $(".pass_control input[type=text], .pass_control input[name=update]").prop("disabled",true);
